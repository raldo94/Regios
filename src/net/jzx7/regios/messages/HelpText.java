...
public enum HelpText {
	GENERAL (new String[] { CMDText.SET.getText()
			, CMDText.CREATE.getText()
			, CMDText.DELETE.getText()
			, CMDText.RENAME.getText()
			, CMDText.INFO.getText()
			, CMDText.LIST.getText()
			, CMDText.LISTFORSALE.getText()
			, CMDText.RELOAD.getText()
			, CMDText.RENAME.getText()
			, CMDText.SETOWNER.getText()}),
			
	MODE (new String[] { CMDText.PROTECTIONMODE.getText()
			, CMDText.PREVENENTRYMODE.getText()
			, CMDText.PREVENTEXITMODE.getText()
			, CMDText.ITEMMODE.getText()}),
