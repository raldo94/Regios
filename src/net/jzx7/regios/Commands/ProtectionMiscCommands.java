...
public class ProtectionMiscCommands extends PermissionsCore {
	...
	public void setDispensersLocked(Region r, String region, String input, Player p) {
		boolean val;
		try {
			val = Boolean.parseBoolean(input);
		} catch (Exception bfe) {
		...
		if (r == null) {
			...
			if (val) {
				p.sendMessage(ChatColor.GREEN + "[Regios] Dispenser Locking enabled for region " + ChatColor.BLUE + region);
			} else {
				p.sendMessage(ChatColor.GREEN + "[Regios] Dispenser Locking disabled for region " + ChatColor.BLUE + region);
			}
		}
	...
	public void setFireSpread(Region r, String region, String input, Player p) {
		boolean val;
		try {
			val = Boolean.parseBoolean(input);
		} catch (Exception bfe) {
		...
		if (r == null) {
			...
			if (val) {
				p.sendMessage(ChatColor.GREEN + "[Regios] Fire Spread enabled for region " + ChatColor.BLUE + region);
			} else {
				p.sendMessage(ChatColor.GREEN + "[Regios] Fire Spread disabled for region " + ChatColor.BLUE + region);
			}
		}
