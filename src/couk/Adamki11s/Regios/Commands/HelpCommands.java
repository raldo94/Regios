...
public class HelpCommands {
	...
	public String[] generalDataText = { ("/r create <region>")
			, ("/r delete <region>")
	...
	public String[] modeText = { ("/r protection-mode <region> <bl/wl>")
			, ("/r prevent-entry-mode <region> <bl/wl>")
			, ("/r prevent-exit-mode <region> <bl/wl>")
			, ("/r item-mode <region> <bl/wl>") };

	public String[] protectionText = { ("/r send-auth <password>")
			, ("/r un/protect-all <region>")
			, ("/r un/protect-bb <region>")
			...
			, ("/r tnt-enabled <region> <T/F>")
			, ("/r player-cap <region> <cap>")
			, ("/r block-form <region> <T/F>") };

	public String[] messagesText = { ("/r set-welcome <region> <message>")
	...
	public String[] funText = { ("/r setwarp")
			, ("/r warp-to <region>")
			, ("/r reset-warp <region>")
			, ("/r lsps <region> <rate>")
			, ("/r pvp <region> <T/F>")
	...
	public String[] otherText = { ("/r mob-spawns <region> <T/F>")
			, ("/r monster-spawns <region> <T/F>")
			, ("/r add-cmd-set <region> <cmd>")
			, ("/r rem-cmd-set <region> <cmd>")
			, ("/r list-cmd-set <region> <cmd>")
			, ("/r reset-cmd-set <region>")
			, ("/r use-cmd-set <region> <T/F>")
			, ("/r set-gamemode <region> <SURVIVAL/CREATIVE/0/1>")
			, ("/r change-gamemode <region> <T/F>")};

	public String[] inventText = { ("/r perm-wipe-entry <region> <T/F>")
			, ("/r perm-wipe-exit <region> <T/F>")
			, ("/r cache-wipe-entry <region> <T/F>")
			, ("/r cache-wipe-exit <region> <T/F>") };

	public String[] exceptionText = { ("/r add-ex <region> <player>")
			, ("/r rem-ex <region> <player>")
			, ("/r list-player-ex <region>")
			, ("/r erase-player-ex <region>")
			, ("/r add-item-ex <region> <itemid>")
			, ("/r rem-item-ex <region> <itemid>")
			, ("/r list-item-ex <region>")
			, ("/r erase-item-ex <region>")
			, ("/r add-node-ex <region> <node>")
			, ("/r rem-node-ex <region> <node>")
			, ("/r list-node-ex <region>")
			, ("/r erase-node-ex <region>")
			, ("/r add-sub-ex <region> <node>")
			, ("/r rem-sub-ex <region> <node>")
			, ("/r list-sub-ex <region>")
			, ("/r reset-sub-ex <region>") };

	public String[] modifyText = { ("/r expand-up <region> <value>")
			, ("/r expand-down <region> <value>")
			, ("/r expand-out <region> <value>")
			, ("/r expand-max <region>")
			, ("/r shrink-up <region> <value>")
			, ("/r shrink-down <region> <value>")
			, ("/r shrink-in <region> <value>")
			, ("/r expand-up <region> <value>")
			, ("/r modify <region>")
			, ("/r modify confirm")
			, ("/r inherit <toinherit> <inheritfrom>") };

	public String[] spoutText = { ("/r set-spout-welcome <region> <message>")
	...
	public String[] permissionsText = { ("/r perm-cache-add <region> <node>")
	...
	public String[] dataText = { ("/r save-region <region> <name>")
